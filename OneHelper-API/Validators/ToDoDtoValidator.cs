...
namespace OneHelper.Validators
{
    public class ToDoDtoValidator : AbstractValidator<ToDoRequest>
    {
        public ToDoDtoValidator()
        {
            ...
            RuleFor(x => x.ComplexityScore).GreaterThanOrEqualTo(1).LessThanOrEqualTo(10).WithMessage("Complexity score must be less than or equal to 10, and greater than or equal to 1");
        }
