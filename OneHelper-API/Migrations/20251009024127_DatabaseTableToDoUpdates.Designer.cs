...
namespace OneHelper.Migrations
{
    ...
    [Migration("20251009024127_DatabaseTableToDoUpdates")]
    partial class DatabaseTableToDoUpdates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OneHelper.Models.ToDo", b =>
                {
                    ...
                    b.ToTable("ToDos", t =>
                        {
                            t.HasCheckConstraint("CK_ToDo_ComplexityScore", "[ComplexityScore] >= 1 AND [ComplexityScore] <= 10");
                        });
                });
